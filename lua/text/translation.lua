...
CONST_TRANSLATION_TEXT_STRINGS.de = {
    ...
    City_MilitarySystem_Skills_Executionl = "- Kann im Kampf tödliche Treffer landen",
};
...
CONST_TRANSLATION_TEXT_STRINGS.en = {
    ...
    City_MilitarySystem_Skills_Executionl = "- Can score fatal blows in battle",
};
...
CONST_TRANSLATION_TEXT_STRINGS.fr = {
    ...
    City_MilitarySystem_Skills_Executionl = "- peut marquer des coups fatals au combat",
};
